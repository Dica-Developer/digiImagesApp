...
(function (document, window) {
  ...
  var hover = function (el) {
      ...
      css(el, {
        position: "absolute",
        transform: "translate(-50%,-50%)" + translate(step.hoverTranslate) + rotate(step.rotate, false) + scale(step.hoverScale),
        transformStyle: "preserve-3d",
  ...
  var unHover = function (el) {
      ...
      css(el, {
        position: "absolute",
        transform: "translate(-50%,-50%)" + translate(step.translate) + rotate(step.rotate, false) + scale(step.scale),
        transformStyle: "preserve-3d",
        transitionProperty: "all",
        transitionTimingFunction: "ease-out",
        transitionDuration: "500ms"
